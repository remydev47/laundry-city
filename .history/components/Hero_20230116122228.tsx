...
const Hero = () => {
  return (
    ...
    <section className={`relative pt-48 pb-12 xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56 ${styles.innerWidth} mx-auto flex flex-col`}>
      <div className="absolute inset-0">
        <img 
        className="object-cover w-full h-full" src="/images/hero.jpg" alt="" 
        />
      </div>
